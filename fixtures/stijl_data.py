STIJLDATA = [
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De barok is een bouwstijl die gekenmerkt wordt door volplastische vormen, gebogen lijnen (concaaf-convex) en een contrast tussen licht en donker, massa en leegte. Kenmerkend voor de barokke gevels zijn de voluut- en klokgevels. Ook werd de kolossale orde ingevoerd op de rijkversierde gevels. Voor de versiering vond de barok haar inspiratie vaak in de oudheid, zoals de zuilenordes en frontons. Deze worden aangevuld met voluten en vlampotten. (grosso modo 17de eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005; Nederlandse Art and Architecture Thesaurus (www.aat-ned.nl).',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 8,
        'labels': [   {   'label': 'classicerende barok',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Lodewijk-XIV-stijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 10,
        'labels': [   {   'label': 'classicisme',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Lodewijk XVI-stijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het classicisme is een strakke architectuur ge\xefnspireerd op de bouwstijl van de klassieke oudheid, zoals de Griekse of Romeinse tempelgevel met fronton en zuilenporticus. Men keerde terug naar de symmetrie en de rechte lijnen. De spaarzame decoratie bestaat onder meer uit: guirlandes of festoenen, consoles, urnen en rozetten. Ook klassieke palmetten, meanders, kraal- en eierlijsten worden aangetroffen. Deze stijl (ca. tweede helft 18de eeuw) gaat in het eerste kwart van de 19de eeuw geleidelijk over in het laatclassicisme.',
                          'type': 'scopeNote'},
                      {   'language': 'nl-BE',
                          'markup': 'HTML',
                          'note': '26/11/2014: aanpassing laatste zin door Leen Meganck, op basis van discussie <a href="https://trac.onroerenderfgoed.be/oei/ticket/2181">https://trac.onroerenderfgoed.be/oei/ticket/2181</a>',
                          'type': 'historyNote'},
                      {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'In de Databank Bouwkundig Erfgoed worden gebouwen in laatclassicistische stijl ook opgenomen onder classicisme.',
                          'type': 'note'}],
        'related': [12],
        'sources': [   {   'citation': 'KOCH W. 1988: De Europese bouwstijlen, Amsterdam.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 31,
        'labels': [   {   'label': 'cottagestijl',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Normandische stijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het creswelliaan is een uitgesproken Noord-Europese traditie (zuidelijk UK). Gidsfossielen zijn de Creswell- en Cheddarspits. Deze traditie kan gedateerd worden van 12500 tot 12000 BP en is gelijktijdig met het hamburgiaan. De aanwezigheid van deze cultuur in Belgi\xeb is nog betwistbaar.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) \n2) VIOE',
                            'markup': None}],
    ...
    {   'id': 63,
        'labels': [   {   'label': 'culturen uit de metaaltijden',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'member_of': [61],
    ...
    {   'id': 62,
        'labels': [   {   'label': 'culturen uit de steentijd',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'member_of': [61],
        'members': [   64,
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De empirestijl is in hoofdzaak een decoratieve stijl (meubels en interieur), waarvan de architectuur motieven heeft overgenomen. Hij werd voor de Franse keizer Napoleon ontwikkeld door de architecten Charles Percier en Fran\xe7ois Fontaine. Deze bouwstijl heeft als basis de neoclassicistische bouwstijl, en combineert deze met napoleontische motieven (zwaan, fasces,...) en motieven die verwijzen naar de Griekse en Egyptische oudheid zoals sfinxen, meanderfriezen, mercuriushoofden of palmetten. Kenmerkend voor de empire-gevels zijn het palladiaans venster, en de rijen gekoppelde rondboogvensters met muurdammen uitgewerkt als pilasters met lijstkapiteel. (ca. 1795 - ca. 1840)',
                          'type': 'scopeNote'}],
        'related': [33, 36],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [],
        'id': 68,
        'labels': [   {   'label': 'enkelgrafcultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'standvoetbekercultuur',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'touwbekercultuur',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze cultuur komt op in Noord-Nederland, Scandinavi\xeb, Duitsland, Polen, Oost-Frankrijk en Zwitserland rond 3000 v.Chr. De enkelgrafcultuur verschijnt dan. Het betreft een vooral Noord-Europese cultuur, gekenmerkt o.a. door aardewerk dat versierd is met touwindrukken (vandaar de alternatieve benaming Touwbekercultuur) en een totaal nieuw grafritueel, nl. individuele in plaats van collectieve begraving. Men vindt ze veel in graven van mannen, meestal samen met een strijdhamer. Deze gepolijste hardstenen bijlen hebben en centrale doorboring en veelal een dubbele snede. Het graf ligt ook hier onder een grafheuvel. De nadruk ligt hier op het individu, vooral de man.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9 &amp; Prof. J. Bourgeois) \n2) VIOE',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        ...
        'labels': [   {   'label': 'federmesser',
                       ...
                       {   'label': 'tjongeriaan',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'tjongercultuur',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'tjongertraditie',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De federmessercultuur sluit technologisch en typologisch zeer nauw aan bij het magdaleniaan en het hamburgiaan. De debitagetechniek is echter minder verzorgd. In de pijlbewapening komt een nieuw spitstype op, nl. de Federmesser- of Tjongerspits. De cultuur kan gerelateerd worden aan het finaalpaleolithicum.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) \n2) VIOE',
                            'markup': None}],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De gotiek is ontstaan dankzij een technisch-constructieve vooruitgang als gevolg van een herverdeling van de krachten via een skeletbouw en schoorwerk. Deze stijl wordt gekenmerkt door haar verticaliteit, grote vensteropeningen, spitsbogen en kruisribgewelven. (ca. 13de eeuw - begin 16de eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005.',
                            'markup': None}],
    ...
    {   'broader': [],
        'id': 82,
        'labels': [   {   'label': 'gravettiaan',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Gravettien',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'p\xe9rigordiaan',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'P\xe9rigordien',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'perigordiaan',
                           'language': 'nl-BE',
    ...
    {   'broader': [],
        'id': 87,
        'labels': [   {   'label': 'groupe de Blicquy',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Regionale variant van Villeneuve/Saint-Germain (Noord-Frankrijk) in Belgi\xeb. Nederzettingen van de Blicquy-groep worden op dezelfde plaatsen teruggevonden als LBK-nederzettingen, nl. aan de bovenloop van de Dender in Henegouwen en in het LBK-gebied in Haspengouw. Wordt gekenmerkt door typisch Blicquy-aardewerk. Deze groep overlapt mogelijk deels met het laatste deel van de LBK en loopt hierna verder.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'Lanting J.N. &amp; Van der Plicht J. 2002, De C14-chronologie van de Nederlandse pre- en protohistorie. III: Neolithicum, in: Palaeohistoria: Acta et communicationes Instituti Bioarchaeologici Universitatis Groniganae 41/42, pp. 1-111.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze groep kan gedateerd worden van 3900 tot 3400 v.Chr. en komt voor in Zuid-Nederland en Belgi\xeb. Het kenmerkt zich door een geheel eigen aardewerkrepertoire.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 115,
        'labels': [   {   'label': 'Hilversum-cultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 123,
        'labels': [   {   'label': 'integratiearchitectuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Integratiearchitectuur omvat een veelal kleinschalige nieuwbouw of verbouwing die zich qua volumes, structuur en vaak ook qua materiaal inschrijft in de omgeving, maar die eigentijds is van vormgeving (circa 1975-1990).',
                          'type': 'scopeNote'},
                      {   'language': 'nl-BE',
                          'markup': None,
                          ...
                          'type': 'historyNote'}],
        'related': [],
        'sources': [   {   'citation': 'CONSTANDT L. 1988: Stenen herleven. 111 jaar kunstige herstellingen in Brugge, Brugge, 94.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Verwijst naar een fase en cultuur van de Europese Kelten in de late ijzertijd, genoemd naar de archeologische vindplaats La T\xe8ne, of De Ondiepe Wateren, bij het Meer van Neuch\xe2tel in Zwitserland. De fase begon in het midden van de 5de eeuw v. Chr. en de cultuur verspreidde zich over Noord-Europa en de Britse Eilanden, om ten slotte halverwege de 1ste eeuw v. Chr. te verdwijnen. La T\xe8ne kenmerkt zich door Griekse en Etruskische invloeden op de traditionele Keltische cultuur en door de sterke geografische verspreiding van de Kelten.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) Nederlandse Art &amp; Architecture Thesaurus, <a href="http://browser.aat-ned.nl/">http://browser.aat-ned.nl/</a> \n2) VIOE',
                            'markup': 'HTML'}],
    ...
    {   'broader': [12],
        'id': 56,
        'labels': [   {   'label': 'Louis-Philippestijl',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 97,
        'labels': [   {   'label': 'michelsbergcultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het micoquiaan kenmerkt zich door asymmetrische vuistbijlvormen en het gebruik van de Levalloistechniek. Het kan deels gelijktijdig met het mousteriaan geplaatst worden (middenpaleolithicum).',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) Cromb\xe9 P. &amp; Van Der Haeghen G. 1994, Twee midden-paleolithische vindplaatsen te Aalter (O.-Vl.), in: P. Cromb\xe9 &amp; G. Van Der Haeghen (eds.), Het midden-paleolithicum in Noordwestelijk Belgi\xeb, pp. 49-95. 2) Onderzoeksbalans Onroerend Erfgoed Vlaanderen <a href="http://www.onderzoeksbalans.be/.">http://www.onderzoeksbalans.be/.</a>',
                            'markup': 'HTML'}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 23,
        'labels': [   {   'label': 'modernisme',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Nieuwe Zakelijkheid',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'Internationale Stijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'functionalisme',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'pakketbootstijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 117,
        'labels': [   {   'label': 'Nederrijnse grafheuvelcultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neobarok inspireert zich op de barokke architectuur.(ca. 1840 tot het interbellum)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neobyzantijnse bouwstijl inspireert zich op de architectuur van het Byzantijnse rijk, met onder meer de centraalbouw, het koepeldak, een veelvuldig gebruik van rondbogen en bepaalde decoratieve elementen zoals moza\xefeken met vergulde achtergronden. (19de eeuw en eerste kwart 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het neoclassicisme inspireert zich op de classicistische architectuur met ornamenten zoals ovale medaillons, laurierguirlandes, voluutconsoles, enz. Deze stroming heeft net zoals het classicisme een voorliefde voor orde en symmetrie, maar gaat vrijer om met de classicistische ornamentiek. De gevels zijn vaak, maar niet altijd, bepleisterd.(tweede helft 19de eeuw en eerste kwart 20ste eeuw)',
                          'type': 'scopeNote'},
                      {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De Louis-Philippestijl is in de Databank Bouwkundig Erfgoed opgenomen onder neoclassicisme.',
                          'type': 'note'}],
        'related': [8, 10, 32],
        'sources': [{   'citation': 'www.irismonument.be', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neo-Egyptische bouwstijl inspireert zich op de architectuur uit de Egyptische oudheid met onder meer bundelzuilen met papyrus- en palmenkapitelen, de holgebogen kroonlijst en de voor deze antieke cultuur typerende versieringen. (19de eeuw en eerste kwart 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'www.irismonument.be', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neo-empire inspireert zich op de empire-architectuur. (tweede helft 19de eeuw en eerste kwart 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [11, 36],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        'id': 13,
        'labels': [   {   'label': 'neogotiek',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'neotudorstijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'},
                       {   'label': 'troubadourstijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neogotiek inspireert zich op de gotische architectuur met o.m. spitsbogen, verticalisme, puntgevels, erkers, enz.(ca.1820 tot WOII)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neomoorse bouwstijl inspireert zich op de Maghrebijnse, Arabische, Osmaanse en Moorse architectuur. Kenmerkend voor deze stijl zijn onder meer minaretten, koepels, hoefijzerbogen en polychromie in de onderbouw. (19de eeuw en eerste kwart 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'VIOE, op basis van Jos Vandenbreeden, Fran\xe7oise Dierkens-Aubry, De 19de eeuw in Belgi\xeb. Architectuur en Interieurs, Tielt, Lannoo, 1994, p.165.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [35],
        'id': 19,
        'labels': [   {   'label': 'neorococo',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'neo-Lodewijk-XV-stijl',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het neorococo inspireert zich op het rococo.(ca. 1860 tot WOII)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neoromaanse bouwstijl inspireert zich op de romaanse architectuur de rondbogen als centraal motief. (19de eeuw tot ca. WO II)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Neostijl is een verzamelnaam voor stijlen vanaf de 19de eeuw die kenmerken van een vroegere stijl opnieuw gebruiken. (19de eeuw en eerste helft 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005.',
                            'markup': None}],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De neotraditionele bouwstijl inspireert zich op de traditionele architectuur, die men eerder vrij gaat incorporeren in een meer eigentijdse vormgeving, met eigentijdse materialen en technieken. (19de eeuw en 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [35],
        'id': 14,
        'labels': [   {   'label': 'neo-Vlaamserenaissance-stijl',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 25,
        'labels': [   {   'label': 'organische architectuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Bij de organische architectuur bepaalt de functie de vorm. Men gaat ervan uit dat de architectuur een invloed uitoefent op de gebruiker. Met schuine plafonds, ronde hoeken en een beweeglijke vormgeving wil men een aangename omgeving cre\xebren voor de gebruiker.',
                          'type': 'scopeNote'}],
        'related': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het postmodernisme zet zich af tegen het functionalisme en de soberheid van het modernisme. Het ornament wordt opnieuw in eer hersteld en moet het gebouw betekenis verlenen. Vormelementen uit het verleden (classicisme, art deco, enz) worden op eigentijdse wijze en vaak met een ondertoon van humor als citaten toegepast. (jaren 1970 en 1980)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'VIOE, o.m. op basis van www.irismonument.be en TRACHTENBERG M. &amp; HYMAN I. 2002: Architecture from Prehistory to Postmodernity, New Jersey.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het regionalisme inspireert zich op de regionale bouwstijl, met zijn lokale, regiogebonden materialen, technieken en vormkenmerken. Vanuit deze elementen cre\xebert men een nieuwe architectuur. Het regionalisme was de dominerende stijl tijdens de wederopbouw na WO I. (laatste kwart 19de eeuw en eerste helft 20ste eeuw)',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [],
        'id': 120,
        'labels': [   {   'label': 'Rhin-Suisse-France Oriental',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De Rhin-Suisse-France ori\xebntale cultuur wordt gekenmerkt door typische urnenvelden, een bloeiende metaalproductie en o. a. nederzettingen aan oevers van meren en rivieren (paaldorpen). Meer oostelijke variant van de Urnenveldencultuur.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. J. Bourgeois) \n2) VIOE',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 102,
        'labels': [   {   'label': 'Rijnbekkengroep',
                           'language': 'nl-BE',
                           'type': 'prefLabel'},
                       {   'label': 'Rheinbasin-kreis',
                           'language': 'nl-BE',
                           'type': 'altLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Het rococo is in hoofdzaak een decoratieve stijl (meubels en interieur), die gekenmerkt wordt door haar speelsheid, lichte kleuren en asymmetrische lijnenspel. Ze dankt haar naam aan de rocaille, het asymmetrische schelpmotief, dat veelvuldig gebruikt wordt als decoratie. (midden 18de eeuw)',
                          'type': 'scopeNote'},
                      {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'In de Databank Bouwkundig Erfgoed wordt ook r\xe9gence opgenomen bij rococo.',
                          'type': 'note'}],
        'related': [],
        'sources': [   {   'citation': 'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005; KOCH W. 1988: De Europese bouwstijlen, Amsterdam.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze cultuur komt tot uiting in westelijk Duitsland en de oostelijke Benelux en kan gedateerd worden tussen 5000 en 4400/4300 v.Chr. Ze ontwikkelde zich in het Rijnland vanuit de Bandkeramische cultuur. De nederzettingen uit de r\xf6ssencultuur zijn versterkt en de gebouwen hebben een trapezo\xefdale plattegrond. In Vlaanderen zijn geen sites van deze cultuur gekend, wel is deze cultuur vertegenwoordigd door een aantal losse vondsten van Breitkeile (soort hamer/bijl).',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) \n2) VIOE',
                            'markup': None}],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze cultuur komt voor in noordelijk Frankrijk en zuidelijk Belgi\xeb en kan gesitueerd worden in het laatneolithicum.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [{   'citation': 'VIOE', 'markup': None}],
        'subordinate_arrays': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze groep is onderdeel van het cultuurcomplex dat geografisch gezien tussen de trechterbekercultuur in het Noorden en de Seine-Oise-Marne-cultuur (waarmee het grote overeenkomsten kent) in het Zuiden ligt. De steingroep kan gedateerd worden tussen 3450 en 2500 v.Chr.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': 'Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen.',
                            'markup': None}],
    ...
    {   'broader': [],
        'id': 109,
        'labels': [   {   'label': 'swifterbantcultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze cultuur komt voor vanaf het finaalpaleoltihicum in Noordwest-Frankrijk en Belgi\xeb. Karakteristieke artefacten zijn de trapeziumvormige pijlpunten. In de rest van Europa komen op hetzelfde moment parallelle culturen voor zoals bv. het aziliaan in Zuid-Frankrijk en Spanje.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) Onderzoeksbalans Onroerend Erfgoed Vlaanderen <a href="http://www.onderzoeksbalans.be/">http://www.onderzoeksbalans.be/</a> \n2) Louwe Kooijmans L., van den Broecke P.W., Fokkens H. en van Gijn A. (eds.), 2005, Nederland in de prehistorie, Amsterdam.',
                            'markup': 'HTML'}],
        'subordinate_arrays': [],
        'type': 'concept',
    ...
    {   'broader': [],
        'id': 112,
        'labels': [   {   'label': 'trechterbekercultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
    ...
    {   'broader': [],
        'id': 121,
        'labels': [   {   'label': 'urnenveldencultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'De urnenveldencultuur kan gedateerd worden tussen 1050 en 800 v.Chr. (late bronstijd tot vroege ijzertijd). Het hoofdkenmerk van de urnenveldencultuur is de veralgemening van de crematie bij behandeling van de dode, de depositie van de crematieresten in een urne en de plaatsing van de urne in vlakgraven in uitgestrekte grafvelden (honderden graven).',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) cursusmateriaal UGent (Prof. J. Bourgeois) \n2) VIOE',
                            'markup': None}],
    ...
    {   'broader': [1],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Bouw in houten stijl- en regelwerk. De open ruimtes worden gevuld met vitswerk (tenen gevlochten omheen vitslatten) waarop leem gesmeerd wordt. De vullingen kunnen ook bestaan uit baksteen.',
                          'type': 'scopeNote'},
                      {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Ook versteende vakwerkbouw is opgenomen in de Databank Bouwkundig Erfgoed.',
                          'type': 'note'}],
        'related': [],
        'sources': [   {   'citation': 'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005.',
                            'markup': None}],
    ...
    {   'broader': [],
        'id': 113,
        'labels': [   {   'label': 'vlaardingencultuur',
                           'language': 'nl-BE',
                           'type': 'prefLabel'}],
        'matches': {   'broad': [],
                        'close': [],
        ...
        'notes': [   {   'language': 'nl-BE',
                          'markup': None,
                          'note': 'Deze cultuur komt voornamelijk voor in Nederland (langsheen kust), maar kent ook enkele sites in Belgi\xeb. Deze cultuur kent mogelijk zijn oorsprong in de hazendonkgroep en de swifterbantcultuur (technologische overeenkomsten). Ze heeft echter wel eigen aardewerkvormen en versiering ontbreekt. Deze traditie kan gedateerd worden tussen 3400 en 2500 v.Chr.',
                          'type': 'scopeNote'}],
        'related': [],
        'sources': [   {   'citation': '1) Louwe Kooijmans L., van den Broecke P.W., Fokkens H. en van Gijn A. (eds.), 2005, Nederland in de prehistorie, Amsterdam. \n2) Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen.',
                            'markup': None}],
        'subordinate_arrays': [],
        'type': 'concept',
