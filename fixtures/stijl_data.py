...
STIJLDATA = [   {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) \n2) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005; Nederlandse Art and Architecture Thesaurus (www.aat-ned.nl).',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [35],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'www.irismonument.be; Nederlandse Art and Architecture Thesaurus (www.aat-ned.nl).',
                          'type': 'note'}],
        u'related': [12],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE, op basis van TRACHTENBERG M. &amp; HYMAN I. 2002: Architecture from Prehistory to Postmodernity, New Jersey.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                      ...
                      {   'language': u'nl',
                          ...
                          'type': 'historyNote'},
                      {   'language': u'nl',
                          'note': u'KOCH W. 1988: De Europese bouwstijlen, Amsterdam.',
                          'type': 'note'},
                      {   'language': u'nl',
    ...
    {   u'broader': [35],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE, op basis van Jos Vandenbreeden, Eclecticisme, in: Jos Vandenbreeden, Fran\xe7oise Dierkens-Aubry, De 19de eeuw in Belgi\xeb. Architectuur en Interieurs, Tielt, Lannoo, 1994, p. 87.',
                          'type': 'note'},
                      {   'language': u'nl',
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9 &amp; Prof. J. Bourgeois) \n2) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [23],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u"VIOE, op basis van PASAMONIK D. 1983: Expo '58 en de atoomstijl, Kortrijk, en HESS A. 2004: Googie Redux. Ultramodern roadside architecture, San Francisco.",
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'Lanting J.N. &amp; Van der Plicht J. 2002, De C14-chronologie van de Nederlandse pre- en protohistorie. III: Neolithicum, in: Palaeohistoria: Acta et communicationes Instituti Bioarchaeologici Universitatis Groniganae 41/42, pp. 1-111.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Theunissen E.M. 1999, Midden-Bronstijdsamenlevingen in het Zuiden van de Lage Landen: een evaluatie van het begrip Hilversum-cultuur, Proefschrift ter verkrijgen van de graad van Doctor, Universiteit Leiden. \n2) cursusmateriaal UGent (Prof. J. Bourgeois) \n3) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen.  2) Nederlandse Art &amp; Architecture Thesaurus, <a href="http://browser.aat-ned.nl/">http://browser.aat-ned.nl/</a>',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        u'id': 93,
        u'labels': [   {   'label': u'lineaire bandkeramiek',
                           'language': u'nl',
                           'type': 'prefLabel'},
                       {   'label': u'LBK',
                           'language': u'nl',
        ...
        u'narrower': [],
        u'notes': [   {   'language': u'nl',
                          'note': u'Deze cultuur dankt haar naam aan het aardewerk met ronde bodems dat met typische banden is versierd. De LBK-cultuur kan gedateerd worden tussen 5500 en 5000/4900 v.Chr. De Bandkeramische verspreiding vanuit Centraal-Europa in westelijke en noordwestelijke richting gebeurde in 4 fasen: de oudste BK, de oude BK, de midden BK en de recent BK-fase. Tegen ca. 5250 v.Chr. heeft de LBK ook Vlaanderen en zijn grootste verspreiding bereikt. De meeste Bandkeramische sites zijn ingeplant op loessgronden, die het best geschikt waren voor primitieve landbouw. Het zijn meestal open dorpen, waar enkele families samen hebben geleefd. Doorgaans bestaan ze uit enkele huizen, die steeds noordwest-zuidoost geori\xebnteerd. De precieze reden voor het plotse verdwijnen van de LBK rond 4900 v.Chr. is vooralsnog niet bekend.',
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) 2) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE, op basis van HASLINGHUIS E.J. &amp; JANSE H. 2005: Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Roymans N. &amp; Kortlang F. 1999, Urnfield symbolism, ancestors and the land in the Lower Rhine Region, in: F. Theuws &amp; N. Roymans (eds.), Land and ancestors: cultural dynamics in the Urnfield Period and the Middle Ages in the Southern Netherlands, Amsterdam Archaeological Studies 4, pp. 33-63. \n2) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [35],
    ...
    {   u'broader': [35],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE, op basis van Jos Vandenbreeden, Fran\xe7oise Dierkens-Aubry, De 19de eeuw in Belgi\xeb. Architectuur en Interieurs, Tielt, Lannoo, 1994, p.165.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [35],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) De Plainseau-cultuur <a href="http://www.patrimoine-mobilier.be/patrimoine/additional_info.aspx?id=214684&amp;LangType=2067">http://www.patrimoine-mobilier.be/patrimoine/additional_info.aspx?id=214684&amp;LangType=2067</a> \n2) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE, o.m. op basis van www.irismonument.be en TRACHTENBERG M. &amp; HYMAN I. 2002: Architecture from Prehistory to Postmodernity, New Jersey.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Lanting J.N. &amp; Van der Plicht J. 1998, De C14-chronologie van de Nederlandse pre- en protohistorie. II: Mesolithicum, in: Palaeohistoria: Acta et communicationes Instituti Bio-archaeologici Universitatis Groninganae 39/40, pp. 99-162. \n2) Louwe Kooijmans L., van den Broecke P.W., Fokkens H. en van Gijn A. (eds.), 2005, Nederland in de prehistorie, Amsterdam.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'HASLINGHUIS, E.J. en JANSE, H., Verklarend woordenboek van de westerse architectuur- en bouwhistorie: bouwkundige termen, Leiden, 2005; KOCH W. 1988: De Europese bouwstijlen, Amsterdam.',
                          'type': 'note'},
                      {   'language': u'nl',
    ...
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Deeben J. e.a. (red.) 2005, De Steentijd van Nederland, Zutphen. \n2) cursusmateriaal UGent (Prof. Ph. Cromb\xe9) \n3) VIOE',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'notes': [   {   'language': u'nl',
                          ...
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'1) Onderzoeksbalans Onroerend Erfgoed Vlaanderen <a href="http://www.onderzoeksbalans.be/">http://www.onderzoeksbalans.be/</a> \n2) Louwe Kooijmans L., van den Broecke P.W., Fokkens H. en van Gijn A. (eds.), 2005, Nederland in de prehistorie, Amsterdam.',
                          'type': 'note'}],
        u'related': [],
        u'type': u'concept'},
    {   u'broader': [],
        ...
        u'narrower': [2],
        u'notes': [   {   'language': u'nl',
                          'note': u'De traditionele architectuur in Vlaanderen is een architectuur in baksteen of in vakwerk.\nHet bakstenen metselwerk wordt gecombineerd met natuurstenen elementen (bv. voor de plint, rond de gevelopeningen, aan de kroonlijst, ...), terwijl in het interieur houten draagconstructies voorkomen. Deze gebouwen bezitten zadeldaken, vaak met trapgevels. ',
                          'type': 'definition'},
                      {   'language': u'nl',
                          'note': u'VIOE',
                          'type': 'note'}],
