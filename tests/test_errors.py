...
class TestErrors:
    def test_skos_reg_error(self):
        ...
        assert "'No SKOS registry found, please check your application setup'" == str(error)
...
class TestErrorsViews:
    def test_integrity(self):
        ...
        assert {'message': 'this operation violates the data integrity and could not be executed'} == res
